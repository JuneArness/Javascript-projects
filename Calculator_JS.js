...
function Handle_Operator(Next_Operator) {
    ...
    //here we add a fixed amoun t of numbers after the decimal
    result = Number(result).toFixed(9)
    //this will remove any trailed 0's
...
keys.addEventListener('click', (event) => {
    ...
    // that was clicked
    const { target } = event;
    // if the elemenet that was clicked is on not a button, exit the function
