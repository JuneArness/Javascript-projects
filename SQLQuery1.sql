...
INSERT INTO tbl_class
    ...
    SELECT persons_fname, persons_lname, person_contact FROM tbl_persons WHERE persons_id BETWEEN 2 AND 5
	SELECT persons_fname, persons_lname, person_contact FROM tbl_persons WHERE persons_lname LIKE 'ke%';

    SELECT persons_frame, persons_lname, pesons_contact FROM tbl_pesons WHERE persons_lname LIKE 'u%s';
   _
    UPDATE tbl_persons SET persons_fname = 'mars' WHERE persons_fname = 'bob';
	
	SELECT person_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_fname LIKE 'm%' ORDER BY persons_lname;
  ...
  CREATE TABLE tbl_specialist (
	  ...
	  specialst_fname VARCHAR(50) NOT NULL,
...
;
  ...
  INSERT INTO tbl_care
	  ...
	  ('care_6', 'drain and refill aquarim', 1),
...
SELECT
	...
	SELECT * FROM tbl_nutrition;
	INNER JOIN tbl_species ON tbl_species_nutrition = tbl_nutrition_id;
	...
	PRINT CHAR(9) + 'I have ' + CONVERT(VARCHAR(50), CHAR(13) + ' dollars...'
...
CREATE TABLE tbl_species (
	...
	species_class INT NOT NULL CONSTRAINT fk_class_id FOREIGN KEY REFERENCES tbl_class(class_id) ON UPDATE CASCADE ON DELETE CASCADE,
	species_order INT NOT NULL CONSTRAINT fk_order_id FOREIGN KEY REFERENCES tbl_order(order_id) ON UPDATE CASCADE ON DELETE CASCADE,
	species_habitat INT NOT NULL CONSTRAINT fk_habitat_id FOREIGN KEY REFERENCES tbl_animalia(animalia_id) ON UPDATE CASCADE ON DELETE CASCADE,
	species_nutrition INT NOT NULL CONSTRAINT fk_nutrition_id FOREIGN KEY REFERENCES tbl_nutrition(nutrition_id) ON UPDATE CASCADE ON DELETE CASCADE,
	species_animalia INT NOT NULL CONSTRAINT fk_care_id FOREIGN KEY REFERENCES tbl_care(care_id) ON UPDATE CASCADE ON DELETE CASCADE,
);
...
INSERT INTO tbl_habitat
	...
	('10 ft pond and rocks', 30000),
	('icy aquarium with snowy facade', 50000),
	('short grass, shade and most', 50000),
	('netted forest atrium', 10000),
	('jungle vines and winding branches', 15000),
	('cliff with shaded cave', 15000)
;
...
INSERT INTO tbl_species
	...
	('brown bear', 1, 102, 3, 5007, 2200, 'care_1'),
	('jaguar', 1, 102, 1, 5007, 2200, 'care_4'),
	('penguin', 1, 100, 1, 5003, 2204, 'care_2'),
	('ghost bat', 1, 102, 1, 5007, 2204, 'care_2'),
	('chicken', 1, 100, 3, 5001, 2205, 'care_0'),
	('panda', 1, 102, 3, 5006, 2202, 'care_4'),
	('bobcat', 1, 102, 1, 5001, 2204, 'care_5'),
...
SELECT
	...
	/* CONVERT(VARCHAR(50), @totalHub) = This is convcerting the data from MOENT to VARCHAR
	 * CHAR(13) = Line Break
	 * CHAR(9) = Tab Key */

	 DECLARE @totalHab MONEY;
	 DECLARE @totalNUT MONEY;
	 DECLARE @reults MONEY;
